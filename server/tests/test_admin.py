...
class AdminStoreTests(unittest.TestCase):
    ...
    def test_payment_test_order_is_prominently_labelled_and_cannot_enter_fulfillment(self):
        ...
        self.assertIn('width="32" height="32"', admin_ui)
        ...
        self.assertIn('/admin.js?v=thumbnail-20260916-3', admin_index)
        self.assertIn('/admin.css?v=thumbnail-20260916-3', admin_index)
        ...
        self.assertIn("width:32px!important;height:32px!important", admin_css)
...
class AdminHttpTests(unittest.TestCase):
    ...
    def test_versioned_admin_assets_force_fresh_thumbnail_ui(self):
        ...
        self.assertIn("/admin.js?v=thumbnail-20260916-3", index)
        status, script, headers = self.request("/admin.js?v=thumbnail-20260916-3")
        self.assertEqual(status, 200)
        self.assertEqual(headers.get("Cache-Control"), "no-store")
        self.assertIn('width="32" height="32"', script)
        ...
        status, css, headers = self.request("/admin.css?v=thumbnail-20260916-3")
        self.assertEqual(status, 200)
        self.assertEqual(headers.get("Cache-Control"), "no-store")
        self.assertIn("width:32px!important;height:32px!important", css)
