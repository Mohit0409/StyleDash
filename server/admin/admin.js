...
const inventoryThumbnail = item => {
  ...
  return source
    ? `<img class="inventory-thumbnail" data-sources="${encodedSources}" data-index="0" src="${escapeText(source)}" alt="${name}" loading="lazy" referrerpolicy="no-referrer" style="width:32px;height:32px;flex:0 0 32px;border:1px solid #dedfd9;border-radius:7px;background:#f5f6f2;object-fit:contain;object-position:center;padding:2px">`
    : '<span class="inventory-thumbnail-fallback" role="img" aria-label="Product image unavailable" style="display:grid;place-items:center;width:32px;height:32px;flex:0 0 32px;border:1px solid #dedfd9;border-radius:7px;background:#f5f6f2;padding:2px;color:#687064;font-size:7px;font-weight:700;line-height:1;text-align:center">No image</span>';
};
