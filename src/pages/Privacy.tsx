...
export const Privacy = () => (
  <div className="max-w-3xl mx-auto p-8 space-y-6">
    <SEO title="Privacy - Vibe4You" />
    <h1 className="text-3xl font-black">Privacy notice</h1>

    <p className="text-sm text-neutral-600">
      Vibe4You is currently operated by {CONFIG.LEGAL.PROPRIETOR_NAME}. This
    ...
    <section className="space-y-2">
      ...
      <p className="text-sm text-neutral-600">
        Depending on how you use Vibe4You, we may handle account identifiers,
    ...
    <section className="space-y-2">
      ...
      <p className="text-sm text-neutral-600">
        Vibe4You uses account authentication, protected sessions, access
