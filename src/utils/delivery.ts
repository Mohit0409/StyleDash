...
export const deliveryAvailabilityMessage = (date = new Date()): string =>
  isExpressDeliveryAvailable(date)
    ? 'Same Day Delivery is available in Neemuch. Express Delivery is also available this Saturday and Sunday.'
    : 'Same Day Delivery is available in Neemuch. Express Delivery is unavailable Monday–Friday.';
