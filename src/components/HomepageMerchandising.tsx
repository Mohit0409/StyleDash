...
export const HomepageMerchandising: React.FC<HomepageMerchandisingProps> = ({ products, loading, avoidProductIds = [] }) => {
  const sections = useMemo(() => buildHomepageSections(products, 5, new Date(), avoidProductIds), [products, avoidProductIds]);
