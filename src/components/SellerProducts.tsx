      ...
      {formOpen && (
        <form onSubmit={saveProduct} className="space-y-4 rounded-2xl border p-4 dark:border-neutral-700">
          ...
          <div className="grid gap-3 text-xs sm:grid-cols-2">
            ...
            <div className="rounded-xl border p-3 dark:border-neutral-700"><p className="font-bold">Delivery schedule</p><p className="mt-1 text-neutral-500">Normal delivery Monday-Friday. Normal + Express delivery Saturday-Sunday for every product.</p></div>
